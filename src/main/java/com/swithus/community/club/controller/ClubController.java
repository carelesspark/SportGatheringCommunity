...
public class ClubController {
    ...
    public void goGreetingsForm(@RequestParam Long clubId, Model model, HttpSession session) {
    ...
    public void goGreetingsDetail(@RequestParam Long clubId, Model model, HttpSession session) {
